  ...
  */
  ...
  const char* SERVER_HOST = "10.229.233.58";
  ...
  void setup() {
    ...
    socketIO.beginSSL("smart-locker-c3vr.onrender.com", 443, "/socket.io/?transport=websocket");
  ...
  void webSocketEvent(WStype_t type, uint8_t* payload, size_t length) {
    switch (type) {
      ...
      case WStype_CONNECTED:
        // SocketIOclient handles connection internally. No connectWebSocket() needed.
